...
image:https://ci.jenkins.io/job/Plugins/job/bootstrap4-api-plugin/job/master/badge/icon[Jenkins, link={https://ci.jenkins.io/job/Plugins/job/bootstrap4-api-plugin/job/master/}]
image:https://github.com/jenkinsci/bootstrap4-api-plugin/workflows/CI%20on%20all%20platforms/badge.svg?branch=master[GitHub Actions, link={https://github.com/jenkinsci/bootstrap4-api-plugin/actions}]
