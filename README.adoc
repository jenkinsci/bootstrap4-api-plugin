...
image:https://github.com/jenkinsci/bootstrap4-api-plugin/workflows/GitHub%20Actions/badge.svg[GitHub Actions, link={https://github.com/jenkinsci/bootstrap4-api-plugin/actions}]
